...
<head>
    ...
    <!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.1/css/bootstrap.rtl.min.css"
        ...
        crossorigin="anonymous" referrerpolicy="no-referrer" /> -->
    <link rel="stylesheet" href="{{asset ("front") }}/styles/pages/main.css">
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-expand-md bg-blue sticky-top">
            <div class="container">
                <div class="navbar-brand">
                    <a class="fw-bold text-white m-0 text-decoration-none h3" href="{{url("home")}}">VCare</a>
                </div>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <div class="d-flex gap-3 flex-wrap justify-content-center" role="group">
                        <a type="button" class="btn btn-outline-light navigation--button" href="{{url("home")}}">Home</a>
        ...
        <div class="row gap-2">
            ...
            <div class="col-sm order-sm-2">
                ...
                <div class="links d-flex gap-2 flex-wrap">
                    <a href="{{url("home")}}" class="link text-white">Home</a>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.1/js/bootstrap.min.js"
        ...
        crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    <script src="{{ asset("front")}}/scripts/home.js"></script>
</body>
