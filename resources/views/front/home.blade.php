            ...
            <div class="container pb-5">
                <div class="row gap-2">
                    <div class="col-sm order-sm-2">
                        <img src="{{asset("front")}}/images/banner.jpg" class="img-fluid banner-img banner-img" alt="banner-image"
                            height="200">
                    </div>
            ...
            <div class="d-flex flex-wrap gap-4 justify-content-center">
                <div class="card p-2" style="width: 18rem;">
                    ...
                    <div class="card-body d-flex flex-column gap-1 justify-content-center">
                        ...
                        <a href="{{url("doctors")}}" class="btn btn-outline-primary card-button">Browse Doctors</a>
                    </div>
                </div>
                <div class="card p-2" style="width: 18rem;">
                    <img src="{{asset("front")}}/images/major.jpg" class="card-img-top rounded-circle card-image-circle"
